...
class __Mustache_6bed41db39711f427fe1f751b582faf4 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '							<div itemscope itemtype="http://schema.org/Organization" class="navbar-brand" id="head-company"><span  itemprop="name">';
