...
class __Mustache_361beea640a38fca17222a128399cff7 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '								<li><a href="products">Products</a></li>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '										<li><a href="#">Turkey Products</a></li>';
        $buffer .= "\n";
        $buffer .= $indent . '										<li><a href="#">Ham Products</a></li>';
        $buffer .= "\n";
        $buffer .= $indent . '										<li><a href="#">Beef Products</a></li>';
        $buffer .= "\n";
