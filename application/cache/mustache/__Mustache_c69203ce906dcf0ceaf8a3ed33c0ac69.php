...
class __Mustache_c69203ce906dcf0ceaf8a3ed33c0ac69 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '								<div id= "head-company-name" itemprop="name"><a class="no-attrib" href="home">';
        ...
        $buffer .= "\n";
        $buffer .= $indent . '										<li><a href="vsboarshead">vs Boar\'s Head</a></li>';
        $buffer .= "\n";
