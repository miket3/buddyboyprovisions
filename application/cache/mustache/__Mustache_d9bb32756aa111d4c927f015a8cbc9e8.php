...
class __Mustache_d9bb32756aa111d4c927f015a8cbc9e8 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= '</a></span></div>';
        $buffer .= "\n";
        $buffer .= $indent . '						<g:plusone></g:plusone>';
        $buffer .= "\n";
        $buffer .= $indent . '						<a href="http://twitter.com/share" class="twitter-share-button" data-count="vertical" data-via="http://www.buddyboyprovisions.com">Tweet</a>';
        $buffer .= "\n";
        $buffer .= $indent . '<div class="fb-like" data-href="https://developers.facebook.com/docs/plugins/" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>';
        $buffer .= "\n";
        $buffer .= $indent . '	';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
