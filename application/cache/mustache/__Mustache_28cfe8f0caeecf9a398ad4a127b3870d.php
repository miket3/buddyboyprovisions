...
class __Mustache_28cfe8f0caeecf9a398ad4a127b3870d extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '		<div class="col-lg-4">';
        $buffer .= "\n";
        $buffer .= $indent . '			<img class="img-circle" src="assets/images/thumanns-toy-truck.jpg" alt="Boar\'s Head Truck">';
        $buffer .= "\n";
