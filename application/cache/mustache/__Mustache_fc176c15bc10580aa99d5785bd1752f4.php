...
class __Mustache_fc176c15bc10580aa99d5785bd1752f4 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '		';
        $buffer .= "\n";
        $buffer .= $indent . '		<link rel="shortcut icon" href="assets/images/Boars-Head-Logo1.ico">';
        $buffer .= "\n";
        $buffer .= "\n";
