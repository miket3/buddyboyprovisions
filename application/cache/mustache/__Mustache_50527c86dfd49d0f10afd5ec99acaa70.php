...
class __Mustache_50527c86dfd49d0f10afd5ec99acaa70 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '					<img src="assets/images/thumanns-bologna.jpg" alt="';
        ...
        $buffer .= "\n";
        $buffer .= $indent . '					<img src="assets/images/thumanns-turkey.jpg" alt="';
        $value = $context->find('Mfg');
        if (!is_string($value) && is_callable($value)) {
            $value = $this->mustache
                ->loadLambda((string) call_user_func($value))
        ...
        $buffer .= $indent . '				<div class="item">';
        $buffer .= "\n";
        $buffer .= $indent . '					<img src="assets/images/thumanns-cheese.jpg" alt="';
        $value = $context->find('Mfg');
        if (!is_string($value) && is_callable($value)) {
            $value = $this->mustache
                ->loadLambda((string) call_user_func($value))
