...
class __Mustache_4ff440faf32b4fcd974d7bc71d7ed425 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<img class="img-circle" src="assets/images/bh-logo.jpeg" alt="Boar\'s Head logo">';
        $buffer .= "\n";
