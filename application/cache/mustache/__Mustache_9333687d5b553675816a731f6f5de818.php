...
class __Mustache_9333687d5b553675816a731f6f5de818 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '								<span  itemprop="name">';
        ...
        $buffer .= "\n";
        $buffer .= $indent . '											<span class="glyphicon glyphicon-earphone"></span> 732-620-7694</a></span></div>';
        $buffer .= "\n";
        $buffer .= $indent . '							';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
