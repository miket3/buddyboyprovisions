...
class __Mustache_25b4790b75d6098f29e036b634802096 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= "\n";
        $buffer .= $indent . '		<form id="contact-form" class="form-signin" role="form" method="post" action="contact/submit">';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			';
        $value = $context->find('sweetcaptcha');
