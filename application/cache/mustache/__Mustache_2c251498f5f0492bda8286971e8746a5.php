...
class __Mustache_2c251498f5f0492bda8286971e8746a5 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '						<a href="http://twitter.com/share" class="twitter-share-button" data-count="vertical" data-via="YourSite">Tweet</a>';
        $buffer .= "\n";
        $buffer .= "\n";
        $buffer .= $indent . '	';
        $buffer .= "\n";
