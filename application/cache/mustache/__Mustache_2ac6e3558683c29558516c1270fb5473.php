...
class __Mustache_2ac6e3558683c29558516c1270fb5473 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= '</a></span></div>';
        $buffer .= "\n";
        $buffer .= $indent . '						<g:plusone size="small" annotation="none"></g:plusone>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '<span class="fb-like" data-href="https://developers.facebook.com/docs/plugins/" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></span>';
        $buffer .= "\n";
        $buffer .= $indent . '	';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
